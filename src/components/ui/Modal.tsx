...
export function Modal({
  ...
  /*
    No AnimatePresence here — presence-managed exits can wedge under React
    StrictMode in dev, and a wedged Modal exit leaves the full-screen
    backdrop on top of the app swallowing every click (looks like a total
    freeze). Enter animations play on mount; close unmounts instantly.
  */
