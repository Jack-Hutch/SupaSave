...
const vars: Record<ThemeVariant, { dark: VarMap; light: VarMap }> = {
  default: {
    ...
    light: {
      ...
      '--expense-soft':    'rgba(220, 38, 38, 0.12)',
  ...
  earth: {
    dark: {
      ...
      '--expense':         '240 108 81',
      '--warn':            '245 158 11',
      '--income-soft':     'rgba(134, 197, 85, 0.12)',
      '--expense-soft':    'rgba(240, 108, 81, 0.12)',
    ...
    light: {
      ...
      '--surface-sunken':  '245 230 205',
      '--border-default':  '232 213 183',
      '--border-subtle':   '245 230 206',
      '--border-strong':   '196 149 106',
      '--foreground':      '44 24 16',
      ...
      '--expense':         '185 28 28',
      '--warn':            '180 83 9',
      '--income-soft':     'rgba(77, 124, 15, 0.12)',
      '--expense-soft':    'rgba(185, 28, 28, 0.12)',
  ...
  noir: {
    dark: {
      ...
      '--expense':         '220 120 120',
      '--warn':            '220 170 80',
      '--income-soft':     'rgba(180, 220, 140, 0.12)',
      '--expense-soft':    'rgba(220, 120, 120, 0.12)',
      '--accent-soft':     'rgba(255, 255, 255, 0.08)',
      '--accent-glow':     'rgba(255, 255, 255, 0.15)',
      '--warn-soft':       'rgba(220, 170, 80, 0.12)',
    },
    light: {
      '--canvas':          '255 255 255',
      '--surface':         '250 250 250',
      ...
      '--surface-sunken':  '244 244 244',
      '--border-default':  '218 218 218',
      '--border-subtle':   '235 235 235',
      '--border-strong':   '160 160 160',
      '--foreground':      '0 0 0',
      ...
      '--expense':         '153 27 27',
      '--warn':            '120 53 15',
      '--income-soft':     'rgba(22, 101, 52, 0.12)',
      '--expense-soft':    'rgba(153, 27, 27, 0.12)',
      '--accent-soft':     'rgba(0, 0, 0, 0.06)',
      '--accent-glow':     'rgba(0, 0, 0, 0.12)',
      '--warn-soft':       'rgba(120, 53, 15, 0.12)',
    },
  },
  ...
  extended: {
    dark: {
      ...
      '--expense':         '251 113 133',
      '--warn':            '251 191 36',
      '--income-soft':     'rgba(94, 234, 212, 0.12)',
    ...
    light: {
      ...
      '--surface-sunken':  '230 224 252',
      '--border-default':  '196 181 253',
      '--border-subtle':   '220 210 255',
      '--border-strong':   '160 130 220',
      '--foreground':      '30 16 64',
      ...
      '--expense':         '190 18 60',
      '--warn':            '161 98 7',
      '--income-soft':     'rgba(15, 118, 110, 0.12)',
      '--expense-soft':    'rgba(190, 18, 60, 0.12)',
